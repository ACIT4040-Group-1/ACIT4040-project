...
def matlab_rgb2hsv(rgbImage): ## need channel last ##
    ...
    hsv = matplotlib.colors.rgb_to_hsv(rgbImage)
...
def imshow(image):### may be deleted as of no use##
    import matplotlib
